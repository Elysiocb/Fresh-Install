#MODULES
import wingetModule #the heart of the program, the "engine" you might say
import interface #the face of the program, the "inter'FACE'" hehe WOW IM SUCH A GENIUS

#FUNCTION
def main() -> None:

    win_mod = wingetModule.wingetModule() #create an instance of the wingetModule class, which will be used to interact with the backend logic of the application
